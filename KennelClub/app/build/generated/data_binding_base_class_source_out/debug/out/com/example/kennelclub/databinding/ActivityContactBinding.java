...
public final class ActivityContactBinding implements ViewBinding {
  ...
  private ActivityContactBinding(@NonNull ConstraintLayout rootView, @NonNull ImageView imageView4,
      @NonNull ImageView imageView5, @NonNull TextView textView5) {
  ...
  public static ActivityContactBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityContactBinding((ConstraintLayout) rootView, imageView4, imageView5,
          textView5);
    }
